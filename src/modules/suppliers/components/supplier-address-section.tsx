 ...
 * addresses are deferred until Purchase documents consume them
 * (27-supplier-management.md's Do Not). */
export function SupplierAddressSection({ control }: SupplierAddressSectionProps) {
  return (
