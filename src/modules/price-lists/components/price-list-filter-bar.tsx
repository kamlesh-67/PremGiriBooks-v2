...
/**
 * Search + status filter for the price list (29-price-lists.md's UI). Filter
 * state lives in the URL so the server page re-queries through
 * priceListService.listPriceLists(filters) — the
 * margin-profile-filter-bar.tsx URL-state pattern.
 */
