...
🟨 In Progress — Accounting Foundation group started (specs drafted, not implemented). Inventory Masters, Business Parties, Pricing, and Shared ERP Engines groups below are not started.
